...
import { ActionsNode, DataWarehouseNode, EventsNode, GroupNode, SystemTableNode } from '~/queries/schema/schema-general'
...
export const customerAnalyticsDashboardEventsLogic = kea<customerAnalyticsDashboardEventsLogicType>([
    ...
    listeners(({ actions, values }) => ({
        saveEvents: () => {
            const events: Record<string, ActionsNode | EventsNode | DataWarehouseNode | SystemTableNode | GroupNode> =
                {}
