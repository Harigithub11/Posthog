...
export const defaultMocks: Mocks = {
    get: {
        ...
        '/api/environments/:team_id/messaging_categories/': EMPTY_PAGINATED_RESPONSE,
        '/api/environments/:team_id/hog_flows/': EMPTY_PAGINATED_RESPONSE,
        '/api/environments/:team_id/hog_flows/:id/': {},
        '/api/environments/:team_id/default_release_conditions/': { enabled: false, default_groups: [] },
        '/api/environments/:team_id/hog_flow_templates/': EMPTY_PAGINATED_RESPONSE,
