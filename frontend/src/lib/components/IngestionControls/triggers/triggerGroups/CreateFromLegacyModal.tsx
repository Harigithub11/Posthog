        ...
        <LemonModal isOpen={isOpen} onClose={onClose} title="Create trigger groups from legacy settings">
            <div className="space-y-4">
                <p className="text-sm text-muted">
                    This will create {previewGroups.length} trigger {previewGroups.length === 1 ? 'group' : 'groups'}{' '}
                    based on your current legacy trigger settings. You can edit these groups after creating them.
                </p>
                ...
                <div className="flex justify-end gap-2 pt-2 border-t">
                    ...
                    <LemonButton type="primary" onClick={onConfirm} loading={isCreating}>
                        Create {previewGroups.length} {previewGroups.length === 1 ? 'group' : 'groups'}
                    </LemonButton>
                </div>
            </div>
        </LemonModal>
