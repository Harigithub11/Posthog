...
describe('replayTriggersV2Logic', () => {
    ...
    describe('previewLegacyGroups selector', () => {
        it('creates a single group when match type is ALL', async () => {
        ...
        it('creates a single group when there are no triggers', async () => {
            await expectLogic(logic, () => {
                teamLogic.actions.loadCurrentTeamSuccess({
                    id: 1,
        ...
        it('creates a single group when match type is ANY but sampling is 100%', async () => {
            await expectLogic(logic, () => {
                teamLogic.actions.loadCurrentTeamSuccess({
                    id: 1,
        ...
        it('creates 2 groups when match type is ANY with triggers and sampling < 100%', async () => {
            await expectLogic(logic, () => {
                teamLogic.actions.loadCurrentTeamSuccess({
                    id: 1,
