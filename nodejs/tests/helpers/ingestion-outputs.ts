...
import { IngestionPipelineOutputs } from '../../src/ingestion/ingestion-pipeline-outputs'
...
export function createTestIngestionOutputs(kafkaProducer: KafkaProducerWrapper): IngestionPipelineOutputs {
    return new IngestionOutputs({
